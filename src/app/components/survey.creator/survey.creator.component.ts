...
Serializer.addProperty("question", { name: 'isFirstItemHidden', type: 'boolean', category: 'general', } );
Serializer.addProperty("question", { name: 'goToPageOnAddorEdit', type: 'string', category: 'general', } );
Serializer.addProperty("question", { name: 'hasEditAction', type: 'boolean', category: 'general', } );
